...
function PostForm(props) {
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function submit$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 16:
            //Submit Form
            if (title.length >= 1 && title.length <= 150 || props.comment) {
  ...
  }, props.locked ? "HAHA NO" : "Post!")), props.edit && __jsx("button", {
...
//# sourceMappingURL=index.js.dbce07339f1a17a14762.hot-update.js.map