...
function Comment(props) {
  ...
  if (editing) {
    return __jsx("div", {
      ...
      edit: true,
      text: c.text,
      onEdit: function _callee4(text, cancel) {
        var res;
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                return _context4.abrupt("return", setEditing(false));

              case 2:
                _context4.prev = 2;
                _context4.next = 5;
                return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default.a.awrap(axios.put("/comment/".concat(c.entity.id), {
                  text: text
                }));
              ...
              case 12:
                //console.log(res);
                props.onEdit(_objectSpread({}, c, {}, res.data, {
                  text: text
                }));
                setEditing(false);
  ...
  }, c.text), replying && __jsx(_PostForm__WEBPACK_IMPORTED_MODULE_15__["PostForm"], {
    comment: c.entity.id,
    cta: "Reply!",
    edit: true,
    onEdit: function _callee5(text, cancel) {
      var u, res;
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              return _context5.abrupt("return", setReplying(false));

            case 2:
              u = id.users[id.active];
              _context5.prev = 3;
              _context5.next = 6;
              return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default.a.awrap(axios.post("/comment/".concat(c.entity.id), {
                text: text
              }));
            ...
            case 13:
              console.log("res", res);
              props.onReply(_objectSpread({}, c, {}, res.data, {
                entity: {
                  id: res.data.id,
...
//# sourceMappingURL=index.js.d03e98b4f8ef759c4b6a.hot-update.js.map