...
function PostContent(_ref) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_2__["useEffect"])(function () {
    bodyRef.current.querySelectorAll("img").forEach(function (elm) {
      elm.setAttribute("title", elm.alt);
      var lnk = document.createElement("a");
      lnk.className = "imageContainer";
      elm.parentNode.replaceChild(elm, lnk);
      lnk.appendChild(elm);
      lnk.href = elm.src;
      elm.addEventListener("click", function (ev) {
        ev.stopPropagation(); //window.open(elm.src, '_blank');
      });
    });
  }, [bodyRef, p.text]);
  ...
  }, !p.entity.comments_hidden ? __jsx(react__WEBPACK_IMPORTED_MODULE_2___default.a.Fragment, null, (p.entity.comment.rgt - p.entity.comment.lft - 1) / 2, " \u2027 ", p.entity.comments_locked ? __jsx(react__WEBPACK_IMPORTED_MODULE_2___default.a.Fragment, null, " ", smR ? __jsx(react_icons_fa__WEBPACK_IMPORTED_MODULE_13__["FaLock"], {
    size: 15,
    __self: this,
    __source: {
      fileName: _jsxFileName,
  ...
  }, "LOCKED")) : __jsx(react__WEBPACK_IMPORTED_MODULE_2___default.a.Fragment, null)) : smR ? __jsx(react_icons_fa__WEBPACK_IMPORTED_MODULE_13__["FaEyeSlash"], {
    size: 20,
    __self: this,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=index.js.5238563b6e7320f608c5.hot-update.js.map